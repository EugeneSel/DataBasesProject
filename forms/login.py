...
class LoginForm(FlaskForm):
    login = StringField('User`s Login', validators=[validators.DataRequired('Please, enter your login: '), validators.Length(8, 20, 'Login consists of minimum 8 symbols, maximum - 20')])
